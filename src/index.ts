  ...
  async fetch(request: Request, env: Env): Promise<Response> {
    ...
    try {
      ...
      if (
        ...
        const invalid = !(request.method == "OPTIONS" || !targetUrl);
        response.body = await getHelp(env, requestUrl);
...
async function getHelp(env: Env, url: URL) {
  ...
  <html>
    ...
    url.hostname
	  ...
	  <p>&nbsp;&nbsp;&nbsp;&nbsp;${url.protocol}//${
    url.hostname
  }/?url=https://api.github.com/repos/streetwriters/notesnook/releases/tags/v2.2.4</p>
	  <p>&nbsp;&nbsp;&nbsp;&nbsp;${url.protocol}//${
    url.hostname
  }/?url=https://api.github.com/repos/streetwriters/notesnook/releases</p>
	  <p>
		<a
